...
(function() {
  ...
  const colors = {
    ...
    Museum: "#ffc8c8",
    Exercise: "#c5ece6",
    Entertainment: "#ffe9a8",
    Personal: "#dfc6ea",
    "Family call time": "#cad4df",
    Makeup: "#f4c5dd",
    Housework: "#d9dfdc",
    Reading: "#c6e9df"
  };

  const labelColor = "#1f2933";
  ...
  function tooltip(containerId) {
    return d3.select(containerId)
      ...
      .style("box-shadow", "0 8px 24px rgba(31, 41, 51, 0.14)")
  ...
  function drawEnergyHeatmap() {
    ...
    const color = d3.scaleSequential(d3.interpolateYlOrRd).domain([10, 100]);
